      ...
      <section id="choose-path" className="container-px py-24 md:py-32">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-2">
          ...
          <Reveal className="flex flex-col rounded-[2rem] border border-ink/10 bg-cream p-8 md:p-10">
            ...
            <ul className="mt-6 space-y-3 text-sm">
              {[
                ...
                [
                  ...
                  links.shoreExcursions,
                  "Independent cruise port excursions, often cheaper than the ship.",
                ],
                [
                  "Exoticca",
                  links.exoticca,
                  "Fully packaged international vacations, flights included.",
                ],
              ].map(([name, href, blurb]) => (
            ...
            <Link
              to="/book-it-yourself"
              className="link-underline mt-auto pt-8"
            >
          ...
          <Reveal
            delay={0.1}
            className="flex flex-col rounded-[2rem] bg-ocean p-8 text-cream md:p-10"
          >
            <div className="flex items-center justify-between">
            ...
            <ul className="mt-6 space-y-3">
              {[
                ...
                "Options shaped around your goals",
                "A real person when details get messy",
              ].map((item) => (
            ...
            <Link
              to="/plan-my-trip"
              className="mt-auto inline-flex items-center gap-1 pt-8 font-semibold text-gold hover:text-cream"
            >
            ...
            {exploreCards.map((card) => {
              ...
              return (
                <motion.div key={card.label} variants={fadeUp}>
                  <Link
                    to={card.to}
                    className="group relative flex h-64 flex-col justify-end overflow-hidden rounded-2xl p-6 shadow-soft"
                  >
                    <img
                      src={card.image}
                      alt={card.label}
      ...
      <section id="about" className="bg-ocean text-cream">
        <div className="container-px grid items-center gap-12 py-24 md:grid-cols-2 md:py-32">
          <Reveal className="relative aspect-[4/5] max-w-md overflow-hidden rounded-[2rem] shadow-lift">
            <img
              src={assets.portrait}
              alt="Brian Voyles, owner and travel advisor"
          ...
          <div className="flex flex-col gap-6">
            ...
            <Reveal delay={0.1}>
              <p className="text-lg leading-relaxed text-cream/80">
                ...
                always does — you've got his number. That's kind of the whole
                point.
              </p>
            </Reveal>
            <motion.div
            ...
            >
              {traits.map((t) => (
                <motion.div
                  key={t.title}
                  variants={fadeUp}
                  className="rounded-2xl bg-ocean-dark/60 p-5"
                >
            ...
            <Reveal delay={0.15}>
              <Link
                to="/about"
                className="inline-flex items-center gap-1 font-semibold text-gold hover:text-cream"
              >
      ...
      <section id="tips" className="container-px py-24 md:py-32">
        <div className="grid items-end gap-8 md:grid-cols-[1.2fr_1fr]">
          ...
          <Reveal className="hidden justify-self-end md:block">
            <img
              src={assets.mascotWhiteboard}
              alt="Brian mascot presenting practical travel tips"
      ...
      <section className="bg-sand/60">
        <div className="container-px py-24 md:py-32">
          <SectionHeading
            ...
            title="Before the obvious questions become emails."
          />
